...
/**
The virtual try-on session manager.

Controls the loading and rendering of sneakers 3D models,
interaction with the camera and taking snapshots.
*/
@interface WsneakersUISDKLayout1Session : WsneakersUISDKSession
///**
...
//*/
//+ (nullable instancetype)createSessionWithConfig:(NSString*)config
...
//@return a newly initialized session object or nil in case of failure
//*/
//+ (nullable instancetype)createWatchSessionWithConfig:(NSString*)config
//                                                     borderCrop:(float)borderCrop
//                                                       progress:(BOOL (^_Nullable)(float progress))progress
//                                                          error:(NSError* __autoreleasing*)error;
//
